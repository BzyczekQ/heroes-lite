...
- 🏚️ **Nowe obiekty mapy**: obserwatoria (🗼 odkrywają teren), świątynie (⛩️ dają XP),
  flagowane siedliska (dają tygodniowe jednostki), artefakty, kopalnie, skarby.
- ⚔️ **Walka na heksach** (15×11) — ruch wg szybkości, strzelcy, latające,
  odwzajemnienie, obrona, czekanie, **czary bojowe**. **Pinch-zoom + przesuwanie**.
